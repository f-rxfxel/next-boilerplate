...
import { Eye, MessageSquare, Edit, Archive, Trash2, Plus, Search, Filter } from "lucide-react"
...
const properties = [
  ...
  },
  {
    ...
    description: "Spacious family home with large garden, perfect for children.",
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="search" placeholder="Search properties..." className="pl-10" />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <CardContent className="p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-sm text-muted-foreground">
                    {property.bedrooms}bd • {property.bathrooms}ba • {property.area}m²
                  </div>
                </div>
