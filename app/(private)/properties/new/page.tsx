...
export default function NewPropertyPage() {
  ...
  const addPhoto = () => {
    setPhotos([
      ...photos,
      `/placeholder.svg?height=200&width=300&text=Photo${photos.length + 1}`,
    ])
  }
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                ...
                <p className='text-sm text-muted-foreground'>
                  Add up to 10 photos. The first photo will be used as the main
                  image.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <Textarea
                    id='amenities'
                    placeholder='List amenities like pool, gym, balcony, etc.'
                    rows={3}
                  />
                </div>
              </CardContent>
